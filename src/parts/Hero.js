        ...
        <div className="flex justify-between items-center">
            <div className="w-1/2">
                ...
                <form onSubmit={submit}>
                    <input type="text" value={state} onChange={(event) => setstate(event.target.value)} className="bg-white focus:outline-none border-0 px-6 py-3 w-1/2" placeholder="You email address" />
            ...
            <div className="w-1/2 flex justify-end pt-24 pr-16">
                <div className="relative" style={{width:369, height:440}}>
                    ...
                    <div className="absolute w-full h-full -mb-8 -ml-8">
                        <img src="/images/img-hero-women.jpg" alt="Testimonial User" />
                    </div>
                <div className="absolute z-10 bg-white py-3 px-4 mt-24" style={{transform: "translateX(-60%)", width: 290}}>
